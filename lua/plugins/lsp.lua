    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('ss', require('snacks.picker').lsp_symbols, 'LSP Symbols')
          map('ss', require('snacks.picker').lsp_workspace_symbols, 'LSP Symbols')
        end,
      })
      ...
      local servers = {
        ...
        -- gopls = {},
        -- pyright = {},
        -- pylyzer = {}, -- note, needed to install node/npm for this plugin to successfully load
        rust_analyzer = {},
        omnisharp = {
          handlers = {
